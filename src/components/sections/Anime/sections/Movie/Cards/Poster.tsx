...
export interface AnimeMoviePosterCardProps {
  item: AnimeListItem;
  variant?: "full" | "bordered";
}

const AnimeMoviePosterCard: React.FC<AnimeMoviePosterCardProps> = ({ item, variant = "full" }) => {
  ...
  const releaseYear = (item as any).year ?? ""; // optional if your mapper includes year
...
export default AnimeMoviePosterCard;
