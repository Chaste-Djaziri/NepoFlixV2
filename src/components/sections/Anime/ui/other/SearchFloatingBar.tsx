// src/components/sections/Anime/ui/other/SearchFloatingBar.tsx
"use client";
  ...
  return (
    <div className="pointer-events-auto absolute left-1/2 top-6 z-40 w-[92%] max-w-2xl -translate-x-1/2">
      <button
        ...
        aria-label="Open anime search (shortcut)"
      >
        <span className="flex items-center gap-2">
          <Search className="h-4 w-4" />
          <span className="opacity-90">Search anime… (press {hotkey})</span>
        </span>
