...
const TvShowRelatedSection = dynamic(() => import("@/components/sections/Anime/sections/TV/Details/Related"));
const TvShowCastsSection = dynamic(() => import("@/components/sections/Anime/sections/TV/Details/Casts"));
const TvShowBackdropSection = dynamic(() => import("@/components/sections/Anime/sections/TV/Details/Backdrop"));
const TvShowOverviewSection = dynamic(() => import("@/components/sections/Anime/sections/TV/Details/Overview"));
const TvShowsSeasonsSelection = dynamic(() => import("@/components/sections/Anime/sections/TV/Details/Seasons"));
