...
const BackdropSection = dynamic(() => import("@/components/sections/Anime/sections/Movie/Detail/Backdrop"));
const OverviewSection = dynamic(() => import("@/components/sections/Anime/sections/Movie/Detail/Overview"));
const CastsSection = dynamic(() => import("@/components/sections/Anime/sections/Movie/Detail/Casts"));
const RelatedSection = dynamic(() => import("@/components/sections/Anime/sections/Movie/Detail/Related"));
...
const MovieDetailPage: NextPage<Params<{ id: number }>> = ({ params }) => {
  ...
  const {
    ...
    queryKey: ["anime-movie-detail", id],
  });
